...
class TestPreprocessing(TestCase):
    ...
    def test_basic_load_blocks(self):
        # tests dataframes are not empty
...
class TestPreprocessingBlock(TestCase):
    """ Test Overview
        ...
        - tests make kin feat df
        - tests make exp feat df
    """
    ...
    def test_median_filter(self):
        # tests filtered_df is same size as original
...
class TestClassificationWorkflow(TestCase):
    """ Test Overview
        ...
        - tests feature selection, plot feature selection
        - tests train and validate
        - tests make single split predictions
    """
...
class TestClassificationHierarchy(TestCase):
    """ Test Overview
        - tests making predictions in hierarhcy
        - tests saving trained models in hierarchy
        - tests loading trained models in hierarchy
